...
```{r}
plot2 <- plot1 + 
  labs(title = "Plot of Heart Rate by Participant and Timepoint",
       subtitle = "Pulse Rate (beats/min)",
       x = "Analysis Day",
       y = "Pulse Rate (beats/min)",
...
xLab <- quo_name(DiaBP_plot$mapping$x)
yLab <- quo_name(DiaBP_plot$mapping$y)
groupLab <- quo_name(DiaBP_plot$mapping$group)

study <- uniqueVal(DiaBP_plot$data$STUDYID)
measure <- uniqueVal(DiaBP_plot$data$PARAM)
